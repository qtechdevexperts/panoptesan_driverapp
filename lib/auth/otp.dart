...
import 'package:panoptesan_alpha/auth/CreateNewPassword.dart';
      ...
      child: Scaffold(
        ...
        body: Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              100.verticalSpace,
              Text('One Time Password', textAlign: TextAlign.left, style: GoogleFonts.inter(fontSize: 30, color: white, fontWeight: FontWeight.w600)),
              10.verticalSpace,
              Text(
