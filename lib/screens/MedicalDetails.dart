...
class _MedicalDetailsScreenState extends State<MedicalDetailsScreen> {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      onWillPop: () async {
        this.profilecontroller.organdonor.clear();
                this.profilecontroller.height.clear();
                this.profilecontroller.weight.clear();
        return true;
      },
      child: Scaffold(
                  ...
                  children: [
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        fillColor: white,
                        hintText:
                            'Please type the name medications you take...',
                        hintStyle: GoogleFonts.inter(
                            fontSize: 12,
                            fontWeight: FontWeight.w300,
                            color: grey),
                    ...
                    DropdownButtonFormField<String>(
                      ...
                      value: null,
                      onChanged: (newValue) {
                        profilecontroller.organdonor.text = newValue!;
                      },
                      items: ["Yes", "No"]
                    ...
                    CustomButton(
                      ...
                      tap: () {
                        ...
                        if (profilecontroller.medicalconditions.text.isEmpty) {
                          return Alert()
                              .showalert("Medical Conditions", context);
                        }
